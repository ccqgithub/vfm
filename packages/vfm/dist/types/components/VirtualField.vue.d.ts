...
declare const _default: {
    new (...args: any[]): {
        ...
        $data: {};
        $props: Partial<{
            form: Form<import("../types").FormType, string>;
            debounce: number;
            rules: VirtualFieldRule<any>[];
        }> & Omit<Readonly<import("vue").ExtractPropTypes<{
            /**
             * The form instance that created by [createForm](../apis/#createform)
             */
            form: {
                type: PropType<Form<import("../types").FormType, string>>;
                default: undefined;
            };
            /**
             * The field name
             ...
             */
            rules: {
                type: PropType<VirtualFieldRule<any>[]>;
                default: () => never[];
            };
            /**
    ...
    $slots: typeof import('./VirtualField.vue.__VLS_template').default;
});
export default _default;
//# sourceMappingURL=VirtualField.vue.d.ts.map